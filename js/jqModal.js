...
(function ($) {
    ...
    $.fn.jqmShowPosition = function (t, pLeft, pTop) { return this.each(function () { t = t || window.event; $.jqm.open(this._jqm, t, pLeft, pTop); }); };

    $.jqm = {
        hash: {},
        open: function (s, t, pLeft, pTop) {
            ...
            //屏幕居中
            if (h.w.css('width') != 'auto') {
                var sWidth = parseInt(h.w.css('width').replace('px', ''));
                var sLeft = document.body.scrollLeft + document.body.clientWidth / 2 - sWidth / 2;
                h.w.css('left', sLeft);
            }
            else {
                h.w.css('left', '50%');
            ...
            if (h.w.css('height') != "auto") {
                var sHeight = parseInt(h.w.css('height').replace('px', ''));
                var sTop = 150 + scrollTop;
                //alert(scrollTop);
